        ...
        <div class="mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-4 px-5 py-8 text-center sm:flex-row sm:px-6 sm:text-left">
          <div>
            ...
            <div class="mt-2 flex items-center gap-2">
              <svg viewBox="0 0 256 116" xmlns="http://www.w3.org/2000/svg" class="h-5 w-auto" aria-hidden="true">
              ...
              <p class="text-[0.75rem] text-muted">Simple scheduling, running on Cloudflare.</p>
            </div>
          </div>
